...
| `max_object_size_mb` | The maximum size of an individual object which can be uploaded to the server via the API or fileimport service.                                                                                                                                                                         | `10`           |
...
| `server.max_object_size_mb`                                         | **DEPRECATED** Use max_object_size_mb at the root instead. The maximum size of an individual object which can be uploaded to the server.                                                                                                                                                          | `10`                                                 |
