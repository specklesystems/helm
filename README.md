...
| `objects.requests.cpu`                                            | The CPU that should be available on a node when scheduling this pod.                                                                                                                                             | `500m`  |
| `objects.requests.memory`                                         | The Memory that should be available on a node when scheduling this pod.                                                                                                                                          | `1Gi`   |
| `objects.limits.cpu`                                              | The maximum CPU that will be made available to the server Pod in a given period.                                                                                                                                 | `1000m` |
